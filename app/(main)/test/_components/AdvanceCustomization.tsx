        ...
        >
          ...
          <div className="flex justify-between w-full items-center">
            <div>
              ...
              <p className="text-xs font-[500] text-[#A1A1AA]">
                Input '0' for No Time Limit
              </p>
            </div>
            <div className="flex items-center bg-gray-100 rounded-lg">
              <button
                onClick={() => decrement(setTime)}
                className=" bg-blue-500 text-white p-1 rounded-md "
              >
                <Minus size={16} />
              </button>
...
export default AdvanceCustomization;
